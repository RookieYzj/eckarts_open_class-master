(function(root, factory) {
  ...
  var didian=[];
  var x=echarts.getMap('china1').geoJson.features;//地图省份数组
  for(var i=0;i<x.length;i++)
  {
    didian.push(x[i].properties.name
    )
  }
  console.log(didian)
  console.log(echarts.getMap('china1').geoJson.features
  )
  localStorage.setItem("a", JSON.stringify(didian))
